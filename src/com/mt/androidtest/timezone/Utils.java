...
public final class Utils extends Utils_SettingsLib {

    private static final String TAG = "Settings";

    public static final boolean IS_QC = "qualcomm".equalsIgnoreCase(SystemProperties.get("ro.lenovo.platform"));
    /**
    ...
    public static final String TYPE_ACTION = "com.lenovo.filebrowser.ENTER_SPECIFICCATEGORY";
    public static final String TYPE_EXTRA_STRING = "category";
    public static final String TYPE_STORAGE_CATEGORY = "storage_category";
    public static final String TYPE_STORAGE_PATH = "storage_path";
    public static final int TYPE_VIEW_STORAGE = 0;
    public static final int TYPE_VIEW_IMAGE = 1;
    public static final int TYPE_VIEW_VIDEO = 2;
    public static final int TYPE_VIEW_MUSIC = 3;
    ...
    public static int getManagedProfileId(UserManager um, int parentUserId) {
        ...
        for (int profileId : profileIds) {
            if (profileId != parentUserId && isManagedProfile(um, profileId)) {
                return profileId;
            }
        }
    ...
    public static UserHandle getSecureTargetUser(IBinder activityToken,
        ...
        try {
            ...
            boolean launchedFromSettingsApp = SETTINGS_PACKAGE_NAME.equals(launchedFromPackage)
                    // huangzq2, Secure Zone, allow secure zone set password across user.
                    || "com.lenovo.seusersettings".equals(launchedFromPackage);
