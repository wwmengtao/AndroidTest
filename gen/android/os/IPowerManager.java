 ...
 * Original file: D:\\workspace\\AndroidTest\\src\\android\\os\\IPowerManager.aidl
 */
package android.os;
/** @hide */
...
case TRANSACTION_setWfdNappingMode:
{
data.enforceInterface(DESCRIPTOR);
long _arg0;
_arg0 = data.readLong();
this.setWfdNappingMode(_arg0);
reply.writeNoException();
return true;
}
case TRANSACTION_setWfdNappingModeWithReason:
{
data.enforceInterface(DESCRIPTOR);
long _arg0;
_arg0 = data.readLong();
int _arg1;
_arg1 = data.readInt();
this.setWfdNappingModeWithReason(_arg0, _arg1);
reply.writeNoException();
return true;
}
...
case TRANSACTION_setBackLightProperties:
{
data.enforceInterface(DESCRIPTOR);
android.os.IBinder _arg0;
_arg0 = data.readStrongBinder();
...
long _arg5;
_arg5 = data.readLong();
this.setBackLightProperties(_arg0, _arg1, _arg2, _arg3, _arg4, _arg5);
reply.writeNoException();
return true;
}
case TRANSACTION_setMMILight:
{
data.enforceInterface(DESCRIPTOR);
int _arg0;
_arg0 = data.readInt();
...
int _arg4;
_arg4 = data.readInt();
this.setMMILight(_arg0, _arg1, _arg2, _arg3, _arg4);
reply.writeNoException();
return true;
}
case TRANSACTION_acquireChargeLimiter:
{
data.enforceInterface(DESCRIPTOR);
android.os.IBinder _arg0;
_arg0 = data.readStrongBinder();
...
java.lang.String _arg5;
_arg5 = data.readString();
this.acquireChargeLimiter(_arg0, _arg1, _arg2, _arg3, _arg4, _arg5);
reply.writeNoException();
return true;
}
case TRANSACTION_acquireChargeLimiterWithUid:
{
data.enforceInterface(DESCRIPTOR);
android.os.IBinder _arg0;
_arg0 = data.readStrongBinder();
...
int _arg4;
_arg4 = data.readInt();
this.acquireChargeLimiterWithUid(_arg0, _arg1, _arg2, _arg3, _arg4);
reply.writeNoException();
return true;
}
case TRANSACTION_releaseChargeLimiter:
{
data.enforceInterface(DESCRIPTOR);
android.os.IBinder _arg0;
_arg0 = data.readStrongBinder();
int _arg1;
_arg1 = data.readInt();
this.releaseChargeLimiter(_arg0, _arg1);
reply.writeNoException();
return true;
}
case TRANSACTION_updateChargeLimiterUids:
{
data.enforceInterface(DESCRIPTOR);
android.os.IBinder _arg0;
_arg0 = data.readStrongBinder();
int[] _arg1;
_arg1 = data.createIntArray();
this.updateChargeLimiterUids(_arg0, _arg1);
reply.writeNoException();
return true;
}
case TRANSACTION_updateChargeLimiterWorkSource:
{
data.enforceInterface(DESCRIPTOR);
android.os.IBinder _arg0;
_arg0 = data.readStrongBinder();
...
java.lang.String _arg2;
_arg2 = data.readString();
this.updateChargeLimiterWorkSource(_arg0, _arg1, _arg2);
reply.writeNoException();
return true;
}
case TRANSACTION_isChargeLimiterLevelSupported:
{
data.enforceInterface(DESCRIPTOR);
int _arg0;
_arg0 = data.readInt();
boolean _result = this.isChargeLimiterLevelSupported(_arg0);
reply.writeNoException();
reply.writeInt(((_result)?(1):(0)));
return true;
}
...
@Override public void setWfdNappingMode(long time) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
_data.writeInterfaceToken(DESCRIPTOR);
_data.writeLong(time);
mRemote.transact(Stub.TRANSACTION_setWfdNappingMode, _data, _reply, 0);
_reply.readException();
}
finally {
_reply.recycle();
...
@Override public void setWfdNappingModeWithReason(long time, int reason) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
_data.writeLong(time);
_data.writeInt(reason);
mRemote.transact(Stub.TRANSACTION_setWfdNappingModeWithReason, _data, _reply, 0);
_reply.readException();
}
finally {
_reply.recycle();
...
@Override public void setBackLightProperties(android.os.IBinder lock, java.lang.String packageName, float gamma, int minimum, int maximum, long timeout) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
_data.writeStrongBinder(lock);
_data.writeString(packageName);
_data.writeFloat(gamma);
_data.writeInt(minimum);
_data.writeInt(maximum);
_data.writeLong(timeout);
mRemote.transact(Stub.TRANSACTION_setBackLightProperties, _data, _reply, 0);
_reply.readException();
}
finally {
_reply.recycle();
...
/* [lenovo_fw,jiangsd2,add_backlight_interface_to_app], end*///lenovo-sw limm3 added for mmi setlight begin

@Override public void setMMILight(int lightId, int color, int flashMode, int onMS, int offMS) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
mRemote.transact(Stub.TRANSACTION_setMMILight, _data, _reply, 0);
_reply.readException();
}
finally {
_reply.recycle();
...
@Override public void acquireChargeLimiter(android.os.IBinder limiter, int flags, java.lang.String tag, java.lang.String packageName, android.os.WorkSource ws, java.lang.String historyTag) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
_data.writeInterfaceToken(DESCRIPTOR);
_data.writeStrongBinder(limiter);
_data.writeInt(flags);
_data.writeString(tag);
_data.writeString(packageName);
if ((ws!=null)) {
...
_data.writeString(historyTag);
mRemote.transact(Stub.TRANSACTION_acquireChargeLimiter, _data, _reply, 0);
_reply.readException();
}
finally {
_reply.recycle();
...
@Override public void acquireChargeLimiterWithUid(android.os.IBinder limiter, int flags, java.lang.String tag, java.lang.String packageName, int uidtoblame) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
_data.writeString(packageName);
_data.writeInt(uidtoblame);
mRemote.transact(Stub.TRANSACTION_acquireChargeLimiterWithUid, _data, _reply, 0);
_reply.readException();
}
finally {
_reply.recycle();
...
@Override public void releaseChargeLimiter(android.os.IBinder limiter, int flags) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
_data.writeStrongBinder(limiter);
_data.writeInt(flags);
mRemote.transact(Stub.TRANSACTION_releaseChargeLimiter, _data, _reply, 0);
_reply.readException();
}
finally {
_reply.recycle();
...
@Override public void updateChargeLimiterUids(android.os.IBinder limiter, int[] uids) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
_data.writeStrongBinder(limiter);
_data.writeIntArray(uids);
mRemote.transact(Stub.TRANSACTION_updateChargeLimiterUids, _data, _reply, 0);
_reply.readException();
}
finally {
_reply.recycle();
...
@Override public void updateChargeLimiterWorkSource(android.os.IBinder limiter, android.os.WorkSource ws, java.lang.String historyTag) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
_data.writeString(historyTag);
mRemote.transact(Stub.TRANSACTION_updateChargeLimiterWorkSource, _data, _reply, 0);
_reply.readException();
}
finally {
_reply.recycle();
...
@Override public boolean isChargeLimiterLevelSupported(int level) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
boolean _result;
...
_data.writeInterfaceToken(DESCRIPTOR);
_data.writeInt(level);
mRemote.transact(Stub.TRANSACTION_isChargeLimiterLevelSupported, _data, _reply, 0);
_reply.readException();
_result = (0!=_reply.readInt());
}
finally {
...
static final int TRANSACTION_setWfdNappingMode = (android.os.IBinder.FIRST_CALL_TRANSACTION + 18);
static final int TRANSACTION_setWfdNappingModeWithReason = (android.os.IBinder.FIRST_CALL_TRANSACTION + 19);
static final int TRANSACTION_reboot = (android.os.IBinder.FIRST_CALL_TRANSACTION + 20);
static final int TRANSACTION_shutdown = (android.os.IBinder.FIRST_CALL_TRANSACTION + 21);
static final int TRANSACTION_crash = (android.os.IBinder.FIRST_CALL_TRANSACTION + 22);
static final int TRANSACTION_setStayOnSetting = (android.os.IBinder.FIRST_CALL_TRANSACTION + 23);
static final int TRANSACTION_boostScreenBrightness = (android.os.IBinder.FIRST_CALL_TRANSACTION + 24);
static final int TRANSACTION_isScreenBrightnessBoosted = (android.os.IBinder.FIRST_CALL_TRANSACTION + 25);
static final int TRANSACTION_setTemporaryScreenBrightnessSettingOverride = (android.os.IBinder.FIRST_CALL_TRANSACTION + 26);
static final int TRANSACTION_setTemporaryScreenAutoBrightnessAdjustmentSettingOverride = (android.os.IBinder.FIRST_CALL_TRANSACTION + 27);
static final int TRANSACTION_setBacklightOffForWfd = (android.os.IBinder.FIRST_CALL_TRANSACTION + 28);
static final int TRANSACTION_setAttentionLight = (android.os.IBinder.FIRST_CALL_TRANSACTION + 29);
static final int TRANSACTION_setBackLightProperties = (android.os.IBinder.FIRST_CALL_TRANSACTION + 30);
static final int TRANSACTION_setMMILight = (android.os.IBinder.FIRST_CALL_TRANSACTION + 31);
static final int TRANSACTION_acquireChargeLimiter = (android.os.IBinder.FIRST_CALL_TRANSACTION + 32);
static final int TRANSACTION_acquireChargeLimiterWithUid = (android.os.IBinder.FIRST_CALL_TRANSACTION + 33);
static final int TRANSACTION_releaseChargeLimiter = (android.os.IBinder.FIRST_CALL_TRANSACTION + 34);
static final int TRANSACTION_updateChargeLimiterUids = (android.os.IBinder.FIRST_CALL_TRANSACTION + 35);
static final int TRANSACTION_updateChargeLimiterWorkSource = (android.os.IBinder.FIRST_CALL_TRANSACTION + 36);
static final int TRANSACTION_isChargeLimiterLevelSupported = (android.os.IBinder.FIRST_CALL_TRANSACTION + 37);
}
// WARNING: The first five methods must remain the first five methods because their
// transaction numbers must not change unless IPowerManager.cpp is also updated.
...
public void setWfdNappingMode(long time) throws android.os.RemoteException;
public void setWfdNappingModeWithReason(long time, int reason) throws android.os.RemoteException;
...
/* [lenovo_fw,jiangsd2,add_backlight_interface_to_app], "Refer to lenovo_fw.txt", add*/
public void setBackLightProperties(android.os.IBinder lock, java.lang.String packageName, float gamma, int minimum, int maximum, long timeout) throws android.os.RemoteException;
/* [lenovo_fw,jiangsd2,add_backlight_interface_to_app], end*///lenovo-sw limm3 added for mmi setlight begin

public void setMMILight(int lightId, int color, int flashMode, int onMS, int offMS) throws android.os.RemoteException;
//lenovo-sw limm3 added for mmi setlight end
/* BEGIN zhangsx10 support charge current limit */
public void acquireChargeLimiter(android.os.IBinder limiter, int flags, java.lang.String tag, java.lang.String packageName, android.os.WorkSource ws, java.lang.String historyTag) throws android.os.RemoteException;
public void acquireChargeLimiterWithUid(android.os.IBinder limiter, int flags, java.lang.String tag, java.lang.String packageName, int uidtoblame) throws android.os.RemoteException;
public void releaseChargeLimiter(android.os.IBinder limiter, int flags) throws android.os.RemoteException;
public void updateChargeLimiterUids(android.os.IBinder limiter, int[] uids) throws android.os.RemoteException;
public void updateChargeLimiterWorkSource(android.os.IBinder limiter, android.os.WorkSource ws, java.lang.String historyTag) throws android.os.RemoteException;
public boolean isChargeLimiterLevelSupported(int level) throws android.os.RemoteException;
}
